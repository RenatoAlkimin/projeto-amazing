...
@section('content')
  <div class="space-y-6">
    ...
    <section class="grid grid-cols-1 md:grid-cols-3 gap-3">
      <div class="card p-5">
        <div class="text-xs uppercase tracking-wide text-[hsl(var(--muted))]">Colaboradores</div>
        <div class="text-2xl font-bold mt-2">—</div>
      </div>

      <div class="card p-5">
        <div class="text-xs uppercase tracking-wide text-[hsl(var(--muted))]">Turnover</div>
        <div class="text-2xl font-bold mt-2">—</div>
      </div>

      <div class="card p-5">
        <div class="text-xs uppercase tracking-wide text-[hsl(var(--muted))]">Aberturas</div>
        <div class="text-2xl font-bold mt-2">—</div>
      </div>
    </section>
    ...
    <section class="card p-6">
      <div class="flex items-start justify-between gap-4">
        ...
        <div class="shrink-0 text-xs card-subtitle">
          ...
          <code class="code-pill">rh.index</code>
        </div>
      </div>
