...
@section('page_subtitle', 'Campanhas (placeholder)')

@section('content')
  <div class="space-y-6">
    <section class="grid grid-cols-1 md:grid-cols-3 gap-3">
      <div class="bg-white border rounded-xl p-5">
        <div class="text-xs uppercase tracking-wide text-gray-500">Leads</div>
        <div class="text-2xl font-bold mt-2">—</div>
      </div>

      <div class="bg-white border rounded-xl p-5">
        <div class="text-xs uppercase tracking-wide text-gray-500">CAC</div>
        <div class="text-2xl font-bold mt-2">R$ —</div>
      </div>

      <div class="bg-white border rounded-xl p-5">
        <div class="text-xs uppercase tracking-wide text-gray-500">ROAS</div>
        <div class="text-2xl font-bold mt-2">—</div>
      </div>
    </section>
    ...
    <section class="bg-white border rounded-xl p-5">
      <div class="flex items-center justify-between">
        ...
        <div class="text-xs text-gray-500">
          Rota: <code class="px-2 py-1 bg-gray-100 rounded">marketing.index</code>
        </div>
      </div>
