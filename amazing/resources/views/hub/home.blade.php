...
@section('content')
  ...
  <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mt-6">
    <a class="block bg-white border rounded p-4 hover:shadow" href="{{ route('comercial.home') }}">
      <div class="font-medium">Comercial</div>
      <div class="text-sm text-gray-600">Pipeline, leads, propostas (placeholder)</div>
    </a>

    <a class="block bg-white border rounded p-4 hover:shadow" href="{{ route('financeiro.home') }}">
      <div class="font-medium">Financeiro</div>
      <div class="text-sm text-gray-600">Recebíveis, extratos (placeholder)</div>
    </a>

    <a class="block bg-white border rounded p-4 hover:shadow" href="{{ route('central.home') }}">
